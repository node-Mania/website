                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="lg:w-1/2 text-left">
                        ...
                        >
                            ...
                            <motion.h1
                                className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-slate-900 leading-tight mb-6"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                transition={{ duration: 0.8 }}
                            >
                                WordPress <span className="text-primary-600">Hosting</span>
                            </motion.h1>
                        ...
                        >
                            ...
                            <div className="relative z-10 w-full h-full bg-white/80 rounded-[2.5rem] border border-slate-200 backdrop-blur-xl p-8 shadow-2xl flex items-center justify-center overflow-hidden group">
                                ...
                                <div className="relative w-full h-full flex flex-col items-center justify-center text-center p-8">
                                    <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mb-6 shadow-2xl shadow-primary/20 border border-slate-100">
                                    ...
                                    <h3 className="text-2xl font-bold text-slate-900 mb-4">Optimised Platform</h3>
                                    <div className="grid grid-cols-2 gap-4 w-full">
                                        <div className="p-3 bg-white border border-slate-100 rounded-xl shadow-sm">
                                            <Gauge className="w-6 h-6 text-teal-600 mx-auto mb-2" />
                                            <p className="text-[10px] text-slate-400 uppercase font-black tracking-tighter">Speed</p>
                                            <p className="text-xs font-bold text-slate-900">100/100</p>
                                        </div>
                                        <div className="p-3 bg-white border border-slate-100 rounded-xl shadow-sm">
                                            <ShieldCheck className="w-6 h-6 text-primary-600 mx-auto mb-2" />
                                            <p className="text-[10px] text-slate-400 uppercase font-black tracking-tighter">Security</p>
                                            <p className="text-xs font-bold text-slate-900">Hardened</p>
                                        </div>
                                        <div className="p-3 bg-white border border-slate-100 rounded-xl shadow-sm">
                                            <RefreshCw className="w-6 h-6 text-indigo-600 mx-auto mb-2" />
                                            <p className="text-[10px] text-slate-400 uppercase font-black tracking-tighter">Updates</p>
                                            <p className="text-xs font-bold text-slate-900">Auto</p>
                                        </div>
                                        <div className="p-3 bg-white border border-slate-100 rounded-xl shadow-sm">
                                            <History className="w-6 h-6 text-amber-600 mx-auto mb-2" />
                                            <p className="text-[10px] text-slate-400 uppercase font-black tracking-tighter">Backups</p>
                                            <p className="text-xs font-bold text-slate-900">Daily</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-slate-400 uppercase font-black tracking-tighter">Environment</p>
                                        <p className="text-sm font-bold text-slate-900">100% Renewable</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-slate-400 uppercase font-black tracking-tighter">WordPress Status</p>
                                        <p className="text-sm font-bold text-slate-900">Secured</p>
                                    </div>
                                </div>
                            </motion.div>
