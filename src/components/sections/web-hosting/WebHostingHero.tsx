            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="lg:w-1/2 text-left">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/90 border border-primary/20 text-white text-xs font-semibold uppercase tracking-wider mb-6">
                                <Zap className="w-3 h-3" />
                                <span>Next-Gen Cloud Hosting</span>
                            </div>

                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
                                Web Hosting <span className="text-primary-400">Reimagined</span>
                            </h1>
                    ...
                    <div className="lg:w-1/2 w-full relative">
                        ...
                        >
                            ...
                            <div className="relative z-10 w-full h-full bg-slate-800/50 rounded-3xl border border-slate-700/50 backdrop-blur-md p-6 shadow-2xl flex items-center justify-center overflow-hidden group">
                                ...
                                {/* Placeholder for a nice server illustration */}
                                <div className="relative w-full h-full">
                                    <Image
                                        // Using a generic server image path that likely exists or use a generated one if needed later
                                        // For now, assume a placeholder or reuse existing asset
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-slate-400">Energy Source</p>
                                        <p className="text-sm font-bold text-white">100% Green</p>
                                    </div>
                                </div>
                            </motion.div>
