...
import { ShieldCheck, Lock, Globe, Zap, ArrowRight, CheckCircle } from 'lucide-react';
...
const HERO_FEATURES = [
    ...
    'Globally Recognized Authorities',
];
                    ...
                    <div className="lg:w-1/2 text-left">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-50 border border-teal-100 text-teal-700 text-xs font-semibold uppercase tracking-wider mb-6">
                                ...
                                <span>Premium Web Security</span>
                            </div>

                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-tight mb-6">
                                Secure Your Website with <span className="text-primary-600">SSL Certificates</span>
                            </h1>

                            <p className="text-xl text-slate-600 mb-8 max-w-xl leading-relaxed">
                                Establish trust, encrypt sensitive data, and improve your SEO rankings with our globally recognized SSL certificates.
                            </p>
                        ...
                        >
                            ...
                            <div className="relative z-10 w-full h-full max-h-[400px] max-w-[400px] bg-white/80 rounded-[2.5rem] border border-slate-200 backdrop-blur-xl p-8 shadow-2xl flex flex-col items-center justify-center overflow-hidden group">
                                ...
                                <div className="mt-8 text-center relative z-20">
                                    ...
                                    <p className="text-slate-400 font-mono text-sm uppercase tracking-tighter">ENCRYPTING DATA...</p>
                                    <p className="text-teal-600 font-bold mt-1 uppercase tracking-widest text-xs">Connection Secured</p>
                                </div>
